...
- "Open in new tab" on the portal page now asks how to open: through the
  router proxy (default) or the portal URL directly — direct mode is required
  for OAuth/SPA portals that cannot run through the HTML proxy
