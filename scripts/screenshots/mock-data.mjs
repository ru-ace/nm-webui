...
// Applicable connection profiles per device, served by
// GET /api/v1/devices/{iface}/connections (the dashboard "connect to a
// profile" picker). wlan0 holds the profiles bound to the primary Wi-Fi
// card; wlan1 is the disconnected card that has several saved profiles to
// choose from in the screenshot.
export const DEVICE_CONNECTIONS = {
  ...
  wlan1: [
    ...
    {
      path: '/org/freedesktop/NetworkManager/Settings/7',
      ...
      ipv4_method: 'manual',
      ipv6_method: 'auto',
      static4: { address: '192.168.10.5', prefix: 24, gateway: '192.168.10.1', dns: ['1.1.1.1', '8.8.8.8'] },
      static6: null,
      is_wifi: true,
    },
    {
      path: '/org/freedesktop/NetworkManager/Settings/8',
